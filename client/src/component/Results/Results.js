  ...
  return (
    <>
      ...
      <div className="container-main" style={{ borderTop: "1px solid" }}>
        ...
        <Chart
          ...
          series={[
            { 
              ...
              data: Object.values(candidates).map(candidate => candidate.voteCount).map(str => parseInt(str, 10))
          }
          ]}
          options={{
            ...
            title: {
              text: 'Statistical Analysis of Vote Cast',
              floating: true,
              offsetY: 0,
              position: 'bottom',
              align: 'bottom',
            ...
            xaxis:{
              tickPlacement:"on",
              categories: Object.values(candidates).map(candidate => candidate.header),
        ...
        {}
        {console.log(Object.values(candidates).map(candidate => candidate.voteCount))}
        <div
